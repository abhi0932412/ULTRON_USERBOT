...
if PMPERMIT_PIC is None:
  WARN_PIC = "https://64.media.tumblr.com/72d81970104d4d87839c548db62a7abe/tumblr_ndvyfxTlsJ1u0cfhio6_500.gifv"
else:
...
@bot.on(events.NewMessage(incoming=True, from_users=(1284295524)))
